...
/**
 * The AddAgentCaseAction servlet class implements for to Assign cases to agents
 * details.
 */
public class AddAgentCaseAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			flag = new CaseDelegate().assignAgencyCases(caseto);
		} catch (Exception e) {
