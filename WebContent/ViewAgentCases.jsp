...
<html>
	...
	<body>
		...
		<center>
			<font color='white'>(Click Caseid to upload Evidences)</font>
						...
						<tr>
							<c:choose>
								<c:when test="${sessionScope.role eq 'Agent'}">
									<td align='center'>
										<b><a
											href="./AddEvidences.jsp?caseid=${cases.caseid }&casename=${cases.casename }">${cases.caseid}
		...
		<% String report="";
           ...
           report+=" <tr><td>CaseId</td><td>CaseName</td><td>CaseAssignedDate</td><td>Case Status</td></tr>"; 
	...
	report+= "<tr><td align='center'><b>"+r.getCaseid()+"</b></td><td align='center'><b>"+r.getCasename()+"</td><td align='center'><b>"+r.getCaseregdate()+"</b></td><td align='center'><b>"+r.getCasestatus()+"</b></td></tr>";
		}
		report+="</table>";
