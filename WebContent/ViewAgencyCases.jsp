	...
	<body>
		...
		<form name='cases' method='post' action='DeleteCases'>
			<table>
				...
				</a><b>//</b><a href="./ExportPDF" target="_blank"><font
						color="brown">PDF</font> </a> </span>
				<br />
				<tr bgcolor='white'>
		...
		<%
			...
			report += " <caption><h3>Agency Case Details</h3> </caption>";
			...
			while (it.hasNext()) {
				...
				report += "<tr><td align='center'><b>" + r.getCaseid()
